...
public class App {
    ...
    public String bestCharge(List<String> inputs) {
        ...
        SalesPromotion salesPromotion = salesDiscountItems.get(0);
        StringBuilder fifOffMessage = new StringBuilder("50% off for certain dishes (");
            ...
            optionalItem.ifPresent(
                    item -> {
                        ...
                        if (salesPromotion.getRelatedItems().contains(item.getId())) {
                            ...
                            fifOffMessage.append(item.getName()).append("，");
                        }
        ...
        if (total.get() > 30) {
            if (discount.get() > 6) {
                ...
                stringBuilder.append("Promotion used:\n")
                        .append("6 yuan off 30 yuan，saving 6 yuan\n")
                        .append("=================================\n");
